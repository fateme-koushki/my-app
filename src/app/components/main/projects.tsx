...
import cartoPng from "../../../public/assets/carto.png"
...
export default function Projects() {
  ...
  return (
    <div id="projects" className=" w-full   flex gap-28 md:gap-0 flex-col md:flex-row items-center justify-center h-full text-center">
      ...
      <PinContainer
        title="https://carto-project.vercel.app"
        href="https://carto-project.vercel.app"
      ...
      >
        <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[20rem] h-[20rem] ">
          ...
          <div className="flex flex-1 w-full rounded-lg mt-4  " >
          <Image  src={cartoPng} alt="project"  className="object-contain w-full  border dark:border-none" />
          </div>
        </div>
      </PinContainer>
    </div>
